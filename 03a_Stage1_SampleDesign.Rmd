...
#raster_path <- file.path(AOI.dir, "1_map_inputs", "covariates", paste0(map_res_character, "_trim")) # williams Lake 
...
#   nearest_town = "Hazelton" 
# 
#   } else if (AOI == "WilliamsLake") {
#   
#   nearest_town = "100 Mile House" 
#   
#   } else if(AOI == "BoundaryTSA"){
#     nearest_town = "Grand Forks"
# }
...
#template <- raster(file.path(raster_path, "aspect.tif"))  
...
rdsRast = fasterize(rdsAll, allRast, field = "speed")

## prep dem for transtion layer             
...
# Boundary towns - Grand Forks, Midway, Greenwood    
cities <- st_read(file.path(shapes_path, "major_towns.gpkg"))
...
# read in and stack landscape scale covariates 
  ...
  #anc_layers <- c( "dah_LS.tif", "mrvbf_LSs.tif","lfclass_st.tif")
...
clhs_set
outname = "s1_sampling_revised_new_only.gpkg"
