...
Note when naming AOI avoid spaces, and use capitals to distinguish between names if desired. i.e DateCreek or WilliamsLake or not really just checking KootenayLake
