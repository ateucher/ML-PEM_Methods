...
model_gen_tidy_nf <- function(trDat, 
                           target, 
                           target2, 
                           outDir = ".", 
                           mname = "model", 
...
#  }
  ...
  RMD <- "D:/PEM_DATA/BEC_DevExchange_Work/_functions/model_gen_tidy_nf.Rmd"
  ...
  file.rename(paste0(outDir,"/", "model_gen_tidy_nf.html"), paste0(outDir,"/", mname,"_treport.html"))
  ## open the report
